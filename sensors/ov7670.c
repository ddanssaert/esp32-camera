...
static const uint8_t default_regs[][2] = {
	...
	{COM11, 0b1000 | 0b10},
	{COM7, 0b100},	/* RGB */
	{COM15, 0b11000000 | 0b010000},

	{COM3, 0x04},  //DCW enable
	{COM14, 0x1a},
	/* Mystery scaling numbers */
	{SCALING_XSC, 0x3a},		{SCALING_YSC, 0x35},
	{SCALING_DCWCTR, 0x22},		{SCALING_PCLK_DIV, 0xf2},
	...
	*/
	{HSTART, 0x18},	{HSTOP, 0x06},
	{HREF, 0x24},	{VSTART, 0x02},
	{VSTOP, 0x7a},	{VREF, 0x00},
...
static int set_pixformat(sensor_t *sensor, pixformat_t pixformat)
{
    ...
    switch (pixformat) {
        case PIXFORMAT_RGB565:
        	...
        	SCCB_Write(sensor->slv_addr, CLKRC, 0x01);
        	SCCB_Write(sensor->slv_addr, COM11, 0b1000 | 0b10);
        	SCCB_Write(sensor->slv_addr, COM7, 0b100);
        	SCCB_Write(sensor->slv_addr, COM15, 0b11000000 | 0b010000);
